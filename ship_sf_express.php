...
class plugin_ship_sf_express {
    ...
    public static function install() {
        ...
        $config['print_bg'] = Ecjia_PluginManager::driver('ship_sf_express')->defaultPrintBackgroundImage();
        $config['config_lable'] = Ecjia_PluginManager::driver('ship_sf_express')->getConfigLabel();
